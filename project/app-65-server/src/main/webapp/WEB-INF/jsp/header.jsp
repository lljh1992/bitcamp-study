...
<div style='background-color: #007bff; color: #fff; padding: 10px; text-align: center; white-space: nowrap;'>
  ...
  <a href='/member/list' style='color: #fff; text-decoration: none; margin: 10px;'>아파트 주차관리 시스템</a>
  <span style='color: #fff; margin: 10px;'></span>
  <a href='/board/list?category=1' style='color: #fff; text-decoration: none; margin: 10px;'>민원사항</a>
  <span style='color: #fff; margin: 10px;'></span>
  <a href='/board/list?category=2' style='color: #fff; text-decoration: none; margin: 10px;'>공지사항</a>

  <c:choose>
    <c:when test="${empty sessionScope.loginUser}">
      <a href='/auth/login' style='color: #fff; text-decoration: none; margin: 10px;'>로그인</a>
    </c:when>
    <c:otherwise>
      ...
      <span style='color: #fff; margin: 10px;'>/</span>
      ${loginUser.name} <a href='/auth/logout' style='color: #fff; text-decoration: none; margin: 10px;'>로그아웃</a>
    </c:otherwise>
  </c:choose>
</div>
