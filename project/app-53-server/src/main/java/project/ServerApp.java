...
public class ServerApp {
  ...
  private void prepareMenu() {
    ...
    noticeMenu.add("notice/add", "등록", facadeListener);
    noticeMenu.add("notice/list", "목록", facadeListener);
    noticeMenu.add("notice/detail", "조회", facadeListener);
    noticeMenu.add("notice/update", "변경", facadeListener);
    noticeMenu.add("notice/delete", "삭제", facadeListener);
