...
public class MemberNetworkDao implements MemberDao {
  ...
  public void saveEntry(Member member) {
    try {
      out.writeUTF(new RequestEntity().command(dataName + "/saveEntry").data(member).toJson());
  ...
  public void saveExit(Member member) {
    try {
      out.writeUTF(new RequestEntity().command(dataName + "/saveExit").data(member).toJson());
