...
public class MemberEntryController implements PageController {

  SqlSessionFactory sqlSessionFactory;
  ParkingTimeDao parkingTimeDao;
  MemberDao memberDao;

  public MemberEntryController(SqlSessionFactory sqlSessionFactory, ParkingTimeDao parkingTimeDao, MemberDao memberDao) {
  ...
  public String execute(HttpServletRequest request, HttpServletResponse response)
    ...
    if (request.getMethod().equals("GET")) {
      return "/WEB-INF/jsp/member/entry.jsp";
    }
