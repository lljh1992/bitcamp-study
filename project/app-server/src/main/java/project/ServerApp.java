...
public class ServerApp {
  ...
  public static final String PROJECT_SESSION_ID = "project_session_id";
  ...
  private NettyOutbound processRequest(HttpServerRequest request, HttpServerResponse response) {
    ...
    try {
      ...
      List<Cookie> cookies = request2.allCookies().get(PROJECT_SESSION_ID);
      if (cookies != null) {
      ...
      if (firstVisit) {
        ...
        response.addCookie(new DefaultCookie(PROJECT_SESSION_ID, sessionId));
      }
