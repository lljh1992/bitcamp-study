...
public class ServerApp {
  ...
  private void prepareMenu() {
    ...
    MenuGroup memberMenu = new MenuGroup("/member", "주차 관리 시스템");
    ...
    memberMenu.add("/member/entry", "입차", facadeListener);
    memberMenu.add("/member/exit", "출차", facadeListener);
    mainMenu.add(memberMenu);

    MenuGroup boardMenu = new MenuGroup("/board", "민원사항");
    ...
    MenuGroup noticeMenu = new MenuGroup("/notice", "공지사항");
    noticeMenu.add("/board/add?category=2", "등록", facadeListener);
    noticeMenu.add("/board/list?category=2", "목록", facadeListener);
    noticeMenu.add("/board/detail?category=2", "조회", facadeListener);
    noticeMenu.add("/board/update?category=2", "변경", facadeListener);
    noticeMenu.add("/board/delete?category=2", "삭제", facadeListener);
