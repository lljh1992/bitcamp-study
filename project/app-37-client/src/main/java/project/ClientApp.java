...
import project.dao.NewMemberNetworkDao;
...
public class ClientApp {
  ...
  public ClientApp(String ip, int port) throws Exception {
    ...
    this.newmemberDao = new NewMemberNetworkDao("newmember", in, out);
    memberDao = new MemberNetworkDao("member", in, out);
    boardDao = new BoardNetworkDao("board", in, out);
    noticeDao = new BoardNetworkDao("notice", in, out);
