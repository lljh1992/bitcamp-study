...
public class ServerApp {
  ...
  public ServerApp(int port) throws Exception {
    ...
    daoMap.put("newmember", new NewMemberListDao("newmember.json"));
  ...
  public void execute() throws Exception {
    ...
    while (true) {
      ...
      if (dao == null) {
        out.writeUTF(new ResponseEntity().status(ResponseEntity.ERROR).result("데이터를 찾을 수 없습니다.").toJson());
        continue;
      }

      Method method = findMethod(dao, methodName);
      if (method == null) {
        out.writeUTF(new ResponseEntity().status(ResponseEntity.ERROR).result("메서드를 찾을 수 없습니다.").toJson());
        continue;
      }
