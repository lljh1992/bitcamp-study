...
import ll.io.BufferedDataInputStream;
import ll.io.BufferedDataOutputStream;
...
public class App {
  ...
  private void loadBoard(List<Board> list) {
    try {
      BufferedDataInputStream in = new BufferedDataInputStream("board.data");
  ...
  private void saveBoard(List<Board> list) {
    try {
      BufferedDataOutputStream out = new BufferedDataOutputStream("board.data");
